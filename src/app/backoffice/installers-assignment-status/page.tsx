...
export default async function BackofficeInstallerAssignmentStatusPage() {
  await requireBackofficeUserPage("/backoffice/installers-assignment-status");
  ...
  return (
    <div className="p-6">
      <div className="max-w-md space-y-4 rounded-xl border border-zinc-200 bg-white p-8 text-center shadow-sm">
        ...
        <h2 className="text-xl font-bold text-zinc-950">기사 배정현황 준비 중</h2>
